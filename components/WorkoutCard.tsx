                    ...
                    <View style={styles.info}>
                      ...
                      <View style={styles.tagContainer}>
                        <View style={styles.tag}>
                          <Ionicons name="body-outline" size={12} color="#FF9500" style={styles.tagIcon} />
                          <Text style={styles.tagText}>{item.muscle}</Text>
                        </View>
                        <View style={styles.tag}>
                          <Ionicons name="barbell-outline" size={12} color="#FF9500" style={styles.tagIcon} />
                          <Text style={styles.tagText}>{item.category}</Text>
                        </View>
                        <View style={styles.tag}>
                          <Ionicons name="star-outline" size={12} color="#FF9500" style={styles.tagIcon} />
