  ...
  const exampleTemplates: WorkoutTemplate[] = [
    {
      ...
      title: "Chest + Triceps",
      workouts: [
        { id: 24, name: "Barbell Bench Press", muscle: "Chest", level: "Intermediate", sets: 4, reps: "8" },
        { id: 25, name: "Incline Dumbbell Bench Press", muscle: "Chest", level: "Advanced", sets: 3, reps: "10" },
        { id: 27, name: "Cable Chest Fly", muscle: "Chest", level: "Intermediate", sets: 3, reps: "12" },
        { id: 73, name: "Skull Crushers (Barbell)", muscle: "Triceps", level: "Intermediate", sets: 3, reps: "10" },
        { id: 74, name: "Overhead Tricep Extension (Dumbbell)", muscle: "Triceps", level: "Intermediate", sets: 3, reps: "12" },
        { id: 75, name: "Cable Tricep Pushdown", muscle: "Triceps", level: "Intermediate", sets: 3, reps: "12" },
        { id: 78, name: "Bench Dip (Bodyweight)", muscle: "Triceps", level: "Intermediate", sets: 3, reps: "12" },
      ],
      isExample: true,
    },
    {
      ...
      title: "Back + Biceps",
      workouts: [
        { id: 43, name: "Deadlift (Barbell)", muscle: "Back", level: "Intermediate", sets: 4, reps: "6" },
        { id: 44, name: "Bent Over Row (Barbell)", muscle: "Back", level: "Intermediate", sets: 4, reps: "8" },
        { id: 45, name: "Pull-ups (Bodyweight)", muscle: "Back", level: "Intermediate", sets: 3, reps: "Max" },
        { id: 63, name: "Bicep Curl (Barbell)", muscle: "Biceps", level: "Intermediate", sets: 3, reps: "10" },
        { id: 64, name: "Bicep Curl (Dumbbell)", muscle: "Biceps", level: "Beginner", sets: 3, reps: "12" },
        { id: 67, name: "Hammer Curl (Dumbbell)", muscle: "Biceps", level: "Intermediate", sets: 3, reps: "12" },
        { id: 65, name: "Cable Bicep Curl", muscle: "Biceps", level: "Intermediate", sets: 3, reps: "12" },
      ],
      isExample: true,
    },
    {
      ...
      title: "Legs",
      workouts: [
        { id: 33, name: "Barbell Squat", muscle: "Legs", level: "Intermediate", sets: 4, reps: "8" },
        { id: 34, name: "Dumbbell Lunge", muscle: "Legs", level: "Intermediate", sets: 3, reps: "12" },
        { id: 35, name: "Leg Press (Machine)", muscle: "Legs", level: "Beginner", sets: 3, reps: "10" },
        { id: 36, name: "Cable Pull-Through", muscle: "Legs", level: "Intermediate", sets: 3, reps: "12" },
        { id: 38, name: "Machine Hack Squat", muscle: "Legs", level: "Intermediate", sets: 3, reps: "10" },
        { id: 39, name: "Dumbbell Step-Up", muscle: "Legs", level: "Intermediate", sets: 3, reps: "12" },
        { id: 100, name: "Seated Calf Raise (Machine)", muscle: "Legs", level: "Beginner", sets: 3, reps: "15" },
      ],
      isExample: true,
    },
    {
      ...
      workouts: [
        { id: 13, name: "Overhead Press (Barbell)", muscle: "Shoulders", level: "Intermediate", sets: 4, reps: "8" },
        { id: 14, name: "Arnold Press", muscle: "Shoulders", level: "Advanced", sets: 3, reps: "10" },
        { id: 15, name: "Lateral Raise", muscle: "Shoulders", level: "Beginner", sets: 3, reps: "15" },
        { id: 75, name: "Cable Tricep Pushdown", muscle: "Triceps", level: "Intermediate", sets: 3, reps: "12" },
        { id: 77, name: "Close-Grip Bench Press (Barbell)", muscle: "Triceps", level: "Advanced", sets: 3, reps: "8" },
        { id: 79, name: "Kickbacks (Dumbbell)", muscle: "Triceps", level: "Intermediate", sets: 3, reps: "12" },
        { id: 16, name: "Front Raise", muscle: "Shoulders", level: "Beginner", sets: 3, reps: "15" },
      ],
      isExample: true,
    },
    {
      ...
      workouts: [
        { id: 3, name: "Plank", muscle: "Core", level: "Intermediate", sets: 3, reps: "60 sec" },
        { id: 5, name: "Ab Wheel Rollout", muscle: "Abs", level: "Advanced", sets: 3, reps: "10" },
        { id: 6, name: "Stability Ball Crunch", muscle: "Core", level: "Intermediate", sets: 3, reps: "15" },
        { id: 9, name: "Mountain Climbers", muscle: "Core", level: "Intermediate", sets: 3, reps: "30" },
        { id: 7, name: "Cable Oblique Crunch", muscle: "Core", level: "Intermediate", sets: 3, reps: "12" },
        { id: 84, name: "Hollow Hold", muscle: "Core", level: "Intermediate", sets: 3, reps: "30 sec" },
        { id: 83, name: "Burpees", muscle: "Core", level: "Intermediate", sets: 3, reps: "Max" },
      ],
      isExample: true,
    },
  ];
